...
|-------|---------------|-----------|-----------------|-----------------|-----------|--------------|
| 1	| Materiality	| HKSA 320	| Trial balance shows PBT HK$75M; user selects 5% benchmark	| Overall materiality = HK$3.75M, <p>Performance = HK$2.8125M, <p>Trivial = HK$187.5K	| N/A	| C |
